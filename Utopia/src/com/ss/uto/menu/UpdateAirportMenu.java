...
public class UpdateAirportMenu {
    public static void show() throws SQLException {
        while (true) {
            Scanner scanner = new Scanner(System.in);
            System.out.println("Which existing airport do you want to update?");
            System.out.println();
            System.out.println("---------------------------------");
            try {
            ...
            try {
                ...
                System.out.print("Enter a updated city: ");
                String city = scanner.nextLine();
                if (city.length() > 45) {
                    System.out.println("City cannot be longer than 45 characters");
                    scanner.next();
//                scanner.close();
                    break;
                } else {
            ...
            try {
                ...
                System.out.println("There was an error updating the airport. Try again.");
                aDao.conn.rollback();
            } finally {
                aDao.conn.close();
                ManageAirportsMenu.show();
